...
class ImageWithCaptionRule extends ConfigurationSelectorRule
{
    ...
    {
        return new ImageWithCaptionRule();
    }
	...
	$caption = $this->getProperty(self::PROPERTY_CAPTION, $node);
	if ($caption) {
		$captionElem = Caption::create();
		$captionElem->withTitle($caption);
		$image->withCaption($captionElem);
	}
